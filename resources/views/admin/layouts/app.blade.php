                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <x-nav-link href="{{ route('peralatan.index') }}" :active="request()->routeIs('peralatan.index')">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Peralatan</span>
                            </x-nav-link>
                        </li>
                        <li>
                            <x-nav-link href="{{ route('adminlogistik.index') }}" :active="request()->routeIs('adminlogistik.index')">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Logistik</span>
                            </x-nav-link>
                        </li>
                        ...
                        @if (Auth::user()->role == 2)
                            ...
                            <li>
                                <x-nav-link href="{{ route('permintaan.index') }}" :active="request()->routeIs('permintaan.index')">
                                    ...
                                    <span class="flex-1 ml-3 whitespace-nowrap">Permintaan Barang</span>
                                </x-nav-link>
                            </li>
                            <li>
                                <x-nav-link href="{{ route('admindistribusi.index') }}" :active="request()->routeIs('admindistribusi.index')">
                                    ...
                                    <span class="flex-1 ml-3 whitespace-nowrap">Distribusi Logistik</span>
                                </x-nav-link>
                            </li>
                            <li>
                                <x-nav-link href="{{ route('adminpinjam.index') }}" :active="request()->routeIs('adminpinjam.index')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
                                    </svg>
                                    <span class="flex-1 ml-3 whitespace-nowrap">Peminjaman Peralatan</span>
                                </x-nav-link>
                            </li>
                        @endif
                        <li>
                            <x-nav-link href="banner" :active="request()->routeIs('')">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
